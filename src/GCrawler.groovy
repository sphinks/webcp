...
class GCrawler extends WebCrawler {
    ...
    Logger LOGGER = Logger.getLogger(GCrawler.class)
     ...
     */
    @Override
    def boolean shouldVisit(WebURL url) {
    ...
    def void visit(Page page) {
        ...
        if (page.getParseData() instanceof HtmlParseData) {
            ...
            CrawlerContentChecks.dataExtractor(html, url)
